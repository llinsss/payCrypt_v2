 ...
 *     description: Retrieves all balance records with pagination support. Rate limited to 1000 requests per hour.
 *     tags: [Balances]
 *     security:
 *       - BearerAuth: []
 *     parameters:
 ...
 *       Each balance includes token amount, USD value, NGN value
 *       (calculated using current exchange rate), and deposit address.
 *     tags: [Balances]
 *     security:
 *       - BearerAuth: []
 *     responses:
 ...
 *       Queries the blockchain for current balances and updates database records.
 *     tags: [Balances]
 *     security:
 *       - BearerAuth: []
 *     responses:
 ...
 *     description: Retrieves token balances for a specific user tag (public endpoint). Cached for 60 seconds.
 *     tags: [Balances]
 *     parameters:
 *       - in: path
 *         name: tag
